...
namespace culebrita
{
    class ProgramColaCircular
    {
        ...
        private static bool MoverLaCulebrita(ColaCircular culebra, Point posiciónObjetivo, //aqui
