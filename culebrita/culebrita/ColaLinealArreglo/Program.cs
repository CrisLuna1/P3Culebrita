...
namespace culebrita
{
    class ProgramColaLinealArreglo
    {
        ...
        private static bool MoverLaCulebrita(ColaLinealArreglo culebra, Point posiciónObjetivo,
        ...
        private static Point MostrarComida(Size screenSize, ColaLinealArreglo culebra) //aqui
        {
        ...
        public void MainColaLineaArreglo()
        {
            var contador = 0;
            var punteo = 0;
            ...
            var culebrita = new ColaLinealArreglo();
