...
namespace culebrita
{
    class ProgramColaListaEnlazada
    {
        ...
        private static bool MoverLaCulebrita(ColaListaEnlazada culebra, Point posiciónObjetivo,
            int longitudCulebra, Size screenSize)
        {
            ...
            // Quitar cola
            if (culebra.num > longitudCulebra)
            {
        ...
        private static Point MostrarComida(Size screenSize, ColaListaEnlazada culebra)
        {
